...
@section('content')
    <form method="POST" class="w-35" enctype="multipart/form-data" action="{{route('insert')}}">
        @csrf
        @method('post')
        <div class="mb-2">
        ...
        <div class="mb-2">
             <input type="file" placeholder="avatar" name="avatar" class="form-control" id="exampleInputPassword1">
            </div>
        <div class="mb-2">
